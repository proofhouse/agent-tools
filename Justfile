...
# Shared container-run prefix that every containerized tool below builds
# on. Shell substitutions evaluate at recipe-run time, not
# Justfile-parse time.
#
...
# pinned by apm.lock.yaml), and the COMMIT_AGENTMSG draft (the
